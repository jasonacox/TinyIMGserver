...
"""
SDXL model handler for TinyIMGserver.

This module provides image generation using the Stable Diffusion XL model.
...
def generate_sdxl_image(prompt: str, height: int = 768, width: int = 768, steps: int = 6, seed: int = None) -> tuple[str, int]:
    """
